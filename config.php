...
// membuat query untuk mengambil nilai dari database
$sql = "SELECT username, pass FROM users WHERE id = 1";

// menjalankan query dan menyimpan hasilnya dalam variabel $result
$result = mysqli_query($connection, $sql);

// mengecek apakah query berhasil dijalankan dan menghasilkan nilai
if (mysqli_num_rows($result) > 0) {
	// mengambil nilai dari hasil query dan menyimpannya dalam variabel $row
	$row = mysqli_fetch_assoc($result);

	// menyimpan nilai dari database ke dalam parameter user
