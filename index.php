...
?>
	...
	<body>
		...
		?>
			<div class="section" id="categoriesbar">
				<div style="text-align: center; overflow: auto; white-space: nowrap;">
					...
					if ($result) {
					?>
						<a href="<?php echo $baseurl ?>#filtercat=all">
						...
						?>
							<a href="<?php echo $baseurl ?>#filtercat=<?php echo $row["category"] ?>">
				...
				?>
							...
							<div class="filmblock">
								...
								<div>
									...
									<div class="realproducttitle" style="display: none"><?php echo $row["title"] ?></div>
									<div class="productoptions" style="display: none"><?php echo $row["options"] ?></div>
									<div style="padding-bottom: 20px; font-size: 25px; font-weight: bold; color: <?php echo $maincolor ?>"><?php echo $oldprice . $currencysymbol . "<span class='thiscurrentpricedisplay'>" . number_format($saleprice, $deccount) ?></span><span style="display: none;" class="thiscurrentprice"><?php echo $saleprice ?></span> <span style="font-size: 12px;">x</span> <input class="productquantity" type="number" value=1 min=1 style="vertical-align: middle; display: inline-block; width: 60px; font-weight: bold; padding: 10px; margin: 5px; border-radius: 0px;" onkeyup="onlyNumbers(this)"></div>
									...
									<div style="padding: 20px;"><a onclick="showmore(<?php echo $productindex ?>)" class="textlink whatsmorebutton" style="cursor: pointer; text-decoration: none;"><i class="fa fa-chevron-down"></i> <?php echo uilang("More") ?></a>
										<div class="whatsmorecontent" style="display: none; padding: 5px; font-size: 12px;"><?php echo shorten_text(strip_tags($row["content"]), 50, " ...") ?><br><a class="textlink" href="<?php echo $baseurl ?>?post=<?php echo $row["postid"] ?>"><?php echo uilang("Continue") ?></a></div>
									</div>
								</div>
							</div>
				<?php
		...
		<section class="section footercopyright">
			<div class="list">
				<li>
					<p href="#">Follow Toko Kelontong Ibuk</p>
				</li>
			</div>

			<div class="footer-icons">
				<ul>
					<li><a href="https://shopee.co.id/emem_mart?v=ee7&smtt=0.0.3"><i class=" bi bi-cart"></i></a> <br></li>
					<li><a href="https://api.whatsapp.com/send/?phone=%2B6285226457536&text&type=phone_number&app_absent=0"><i class="bi bi-whatsapp"></i></a> <br></li>
					<li><a href="https://www.instagram.com/ahmdirvn__/?hl=en"><i class="bi bi-instagram"></i></a> <br></li>
		...
		<script>
			...
			function showcartui() {
				...
				cartdata += "<label><?php echo uilang("Delivery Method") ?></label><select id='cdmethod'><?php echo uilang("Delivery Method") ?><option>Antar ke Rumah</option><option>COD</option><option>Ambil Di Tempat (PASAR MAYONG)</option></select>"
