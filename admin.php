...
<head>
	<title>Dashboard Admin | <?php echo $websitetitle ?></title>
	<meta charset="utf-8">
					...
					<div class="adminmenubar">
						<div class="stickythingy">
							...
							<a href="<?php echo $baseurl ?>admin.php?logout">
								<div class="adminleftbaritem"><i class="fa fa-sign-out" style="width: 30px;"></i> <?php echo uilang("Logout") ?></div>
							</a>

							<div style="text-align: center; padding: 30px; font-size: 10px;"><br><a target="_blank" class="textlink" style="color: lime;"></a><br><br>Developed By<br>
								<class="textlink" style="color: lime;">https://www.linkedin.com/in/ahmadirvanmaulana/</a>
							</div>
						</div>
					</div>
						...
						//settings
							...
							<form method="post" enctype="multipart/form-data">
								...
								<select name="disabledecimals">
									<option value=0 <?php if ($cfg->disabledecimals == "0") {
														echo "selected";
													} ?>><?php echo uilang("No") ?></option>
									<option value=1 <?php if ($cfg->disabledecimals == "1") {
														echo "selected";
													} ?>><?php echo uilang("Yes") ?></option>
								</select>
								<br>
								...
								<select name="thumbnailmode">
									<option value=0 <?php if ($cfg->thumbnailmode == "0") {
														echo "selected";
													} ?>><?php echo uilang("Center Filled") ?></option>
									<option value=1 <?php if ($cfg->thumbnailmode == "1") {
														echo "selected";
													} ?>><?php echo uilang("Stretched Width or Height") ?></option>
								</select>
								<br>
								...
								<input type="checkbox" name="sharebuttonsoption[]" value="Facebook" <?php if (IsChecked($sharebuttonsoption, "Facebook")) {
																										echo "checked";
																									} ?>><label for="sbo1" style="display: inline-block;">Facebook</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="Twitter" <?php if (IsChecked($sharebuttonsoption, "Twitter")) {
																										echo "checked";
																									} ?>><label for="sbo2" style="display: inline-block;">Twitter</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="Email" <?php if (IsChecked($sharebuttonsoption, "Email")) {
																										echo "checked";
																									} ?>><label for="sbo3" style="display: inline-block;">Email</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="Pinterest" <?php if (IsChecked($sharebuttonsoption, "Pinterest")) {
																											echo "checked";
																										} ?>><label for="sbo4" style="display: inline-block;">Pinterest</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="Linkedin" <?php if (IsChecked($sharebuttonsoption, "Linkedin")) {
																										echo "checked";
																									} ?>><label for="sbo5" style="display: inline-block;">Linkedin</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="WhatsApp" <?php if (IsChecked($sharebuttonsoption, "WhatsApp")) {
																										echo "checked";
																									} ?>><label for="sbo6" style="display: inline-block;">WhatsApp</label>
								<input type="checkbox" name="sharebuttonsoption[]" value="Telegram" <?php if (IsChecked($sharebuttonsoption, "Telegram")) {
																										echo "checked";
																									} ?>><label for="sbo7" style="display: inline-block;">Telegram</label>
		...
		?>
			<div class="loginform">
				<div style="text-align: center; padding: 20px;">
					...
					<p><?php echo $websitetitle ?> - Dashboard Admin</p>
				</div>
